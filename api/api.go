...
import (
	...
	"github.com/febrielven/go_backend_webcompro/api/controllers"
	"github.com/febrielven/go_backend_webcompro/api/database"
	"github.com/febrielven/go_backend_webcompro/api/models"
	"github.com/febrielven/go_backend_webcompro/api/repository"
	"github.com/febrielven/go_backend_webcompro/api/routes"
	"github.com/gorilla/handlers"
	"github.com/gorilla/mux"
)

var (
	port        = flag.Int("p", 5060, "set port")
